#!/usr/bin/env python3
"""
Patch OpenCode opencode.json with secrets from the environment (Proton Pass).
...
Usage:
    patch_opencode_secrets.py ~/.config/opencode/opencode.json \
...
def main() -> int:
    ...
    parser.add_argument("config_path", help="Path to opencode.json")
    ...
    # we'd need a full JSONC parser/writer; opencode.json is auto-generated by
