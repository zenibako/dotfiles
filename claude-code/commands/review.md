---
description: Review code changes — uncommitted, a commit hash, branch, or PR URL/number
---
...
- Check for existing style guide or conventions files (CONVENTIONS.md, AGENTS.md, CLAUDE.md, .editorconfig, etc.)
